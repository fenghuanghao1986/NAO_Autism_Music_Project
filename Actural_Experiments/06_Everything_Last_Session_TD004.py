...
#           Play custom song
            dt = 0.5
            keys = [0,0,2,2,7,6,5,2,0,0,2,2,7,6,5,3,0,0,
                    3,3,8,7,6,9,9,9,9,10,9,8,6,5,0,0,
                    7,7,7,0,7,7,7,0,7,9,5,6,7,0,0,
            ...
            time.sleep(3.0)
            tts.say("Yes, it is Jingle Bell Jingle Bell!")
            time.sleep(3.0)
...
#            colorNames = ['red', 'green', 'blue']
            ...
            tts.say("I just played few notes, can you repeat them for me? \
                    ...
                    for example brown, brown, pink, blue, gray, brown.")
...
#       second half song 
            ...
            keys = [0,0,7,7,7,0,7,7,7,0,7,9,5,6,7,0,0,
                    8,8,8,8,8,7,7,7,7,6,6,7,6,0,9,0]
            dt1 = 1
            name = 'FaceLeds'
#            colorRGB = ['0x00FF0000', '0x0000FF00', '0x000000FF',
