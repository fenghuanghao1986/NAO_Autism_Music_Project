    ...
    for expression_num = 1:6
        ...
        if loop_num ~= 0;
            ...
            for i = 1:loop_num
                ...
                expression_m_q2_plot = znorm_q2_filter{file_num}(((start_frame) * 32): ((end_frame ) * 32));
                ...
                expression_m_q1_spect{file_num, i} = imresize(expression_m_q1, [100, 32 ], ...
                    'bicubic');
                expression_m_q2_spect{file_num, i} = imresize(expression_m_q2, [100, 32 ], ...
                    'bicubic');
...
%         
                ...
                q2_save_name = sprintf('subject_%d_expression_%s_q2_clip_%d.mat', file_num, expression, i);
                ...
                saveas(id2, strcat(save_folder, sprintf('subject_%d_expression_%s_q2_%s_clip_%d.fig', ...
                    file_num, expression, fileNames{file_num}, i)));
                saveas(id2, strcat(save_folder, sprintf('subject_%d_expression_%s_q2_%s_clip_%d.tif', ...
                    file_num, expression, fileNames{file_num}, i)));
